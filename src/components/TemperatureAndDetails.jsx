...
function TemperatureAndDetails({weather: {details, icon, temp, temp_min, temp_max, feels_like, sunrise, sunset, speed, humidity, timezone}}) {
  return (
    <div>
        ...
        <div className='flex items-center justify-evenly text-white py-3'>
