    ...
    const handleUnitsChange= (e) =>{
        ...
        <div className='flex flex-row justify-evenly my-6'>
            <div className='flex flex-row w-3/4 items-center justify-center space-x-4'>
                ...
                className='text-xl font-light p-2 md:w-[70%] w-full shadow-xl focus:outline-none capitalize 
                placeholder:lowercase' placeholder='search city...' />

                <UilSearchAlt size={25} className="text-white cursor-pointer transition ease-out hover:scale-125" onClick={handleSearchClick} />

                <UilMapPinAlt size={25} className="text-white cursor-pointer transition ease-out hover:scale-125" onClick={handleLocationClick}/>
            </div>
